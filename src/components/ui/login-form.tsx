...
export function SmokeyBackground({
  ...
  color = "#00A884", // Default ChatApp emerald green
  className = "",
 ...
 */
export function LoginForm({ onSignIn, onGoogleSignIn, onSignUpClick }: LoginFormProps) {
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        ...
        <div className="relative z-0">
          <input
            ...
            className="block py-2.5 px-0 w-full text-sm text-white bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-[#00a884] peer"
            placeholder=" " 
            required
          />
          <label
            htmlFor="floating_email"
            className="absolute text-sm text-gray-300 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-[#00a884] peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6"
          >
        ...
        <button
          type="submit"
          className="group w-full flex items-center justify-center py-3 px-4 bg-[#00a884] hover:bg-[#007a61] rounded-lg text-white font-semibold focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-900 focus:ring-[#00a884] transition-all duration-300 cursor-pointer"
        >
          Sign In
        ...
        <button
          ...
          className="w-full flex items-center justify-center py-2.5 px-4 bg-white/90 hover:bg-white rounded-lg text-gray-700 font-semibold focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-900 focus:ring-[#00a884] transition-all duration-300 cursor-pointer"
        >
       ...
       <p className="text-center text-xs text-gray-400">
        Don't have an account? <a href="#" onClick={(e) => { e.preventDefault(); onSignUpClick?.(); }} className="font-semibold text-[#00a884] hover:text-emerald-300 transition">Sign Up</a>
      </p>
    </div>
  );
}
